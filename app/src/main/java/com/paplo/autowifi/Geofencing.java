...
public class Geofencing implements ResultCallback {
    ...
    void unRegisterAllGeofences() {
        ...
        try {
            Log.d(TAG, "Geofences unregistered");
    ...
    void updateGeofencesList(PlaceBuffer places, List<String> radiusList) {

        Log.d(TAG, "Geofences updated");
        ...
        for (Place place : places) {
            String radiusString = radiusList.get(run);
            int radius = (int) Float.parseFloat(radiusString);
            Log.d(TAG, "Geofence radius: " + radius);
